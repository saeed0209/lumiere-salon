...
const Header = () => {
  ...
  return (
    <header className="bg-linear-to-r from-pink-100 to-purple-100 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        <a
          href="/"
          className="flex items-center focus:outline-none focus:ring-2 focus:ring-pink-600 rounded"
        >
          <h1 className="text-2xl font-bold text-pink-600">Lumière Salon</h1>
        </a>
        <nav
        ...
        <button
          className="md:hidden p-2 focus:outline-none focus:ring-pink-600 rounded"
          onClick={toggleMenu}
